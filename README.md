...
2.  **Basic Types**
    ...
    3. _Lattices_
        ...
        -  lattice (and unitcell) editing (adding/removing sites and bonds) [[notebook](https://github.com/janattig/LatticePhysics_Tutorials/blob/master/basics/lattices/lattice_editing.ipynb)]
